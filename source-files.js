...
sourcesIndex["codespan"] = {"name":"","files":["codemap.rs","filemap.rs","index.rs","lib.rs","span.rs"]};
sourcesIndex["codespan_reporting"] = {"name":"","files":["diagnostic.rs","emitter.rs","lib.rs"]};
...
sourcesIndex["mdbook"] = {"name":"","dirs":[{"name":"book","files":["book.rs","init.rs","mod.rs","summary.rs"]},{"name":"preprocess","files":["cmd.rs","index.rs","links.rs","mod.rs"]},{"name":"renderer","dirs":[{"name":"html_handlebars","dirs":[{"name":"helpers","files":["mod.rs","navigation.rs","theme.rs","toc.rs"]}],"files":["hbs_renderer.rs","mod.rs"]}],"files":["mod.rs"]},{"name":"theme","dirs":[{"name":"playpen_editor","files":["mod.rs"]}],"files":["mod.rs"]},{"name":"utils","files":["fs.rs","mod.rs","string.rs"]}],"files":["config.rs","lib.rs"]};
sourcesIndex["mdbook_linkcheck"] = {"name":"","files":["cache.rs","config.rs","lib.rs","links.rs","validate.rs"]};
